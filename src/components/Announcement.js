    ...
    return (
      <div className="announcements">
        ...
        <p className="leftaligned px-3 py-1">
          The Organizer Training 101 (OT 101) is a two day event from 9am to 5pm in Hillsborough NC, where two experienced workplace organizers share the IWW's strategy for organizing your workplace.
