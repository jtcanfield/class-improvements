  ...
  render() {
    return (
      <div className="announcements">
        ...
        <h5 className="p-2">
          The Raleigh-Durham IWW is hosting an Organizer Training 101 on May 18-19!
        </h5>

        <h4 className="p-2">
          <a href="https://goo.gl/forms/ToVsewTRh5aeEqJ23" target="_blank" rel="noopener noreferrer">
            Register Now
          </a>
        </h4>

        <p className="leftaligned px-3 py-1">
          The Organizer Training 101 (OT 101) is a two day event from 9am to 5pm at 430 Waterstone Dr. Hillsborough NC 27278, where two experienced workplace organizers share the IWW's strategy for organizing your workplace.
          ...
          The training is 8 hours each day with a lunch break, so please contact us if we can help you with anything.
        </p>
