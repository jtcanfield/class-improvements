  ...
  render() {
    return (
      <div className="Donate component">
        ...
        <p>However, if you really want to donate money, you can donate via our <a href="https://www.paypal.me/rdiwwgmb" target="_blank" rel="noopener noreferrer">paypal here</a></p>
      </div>
    );
  }
}
